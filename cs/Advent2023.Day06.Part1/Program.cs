...
namespace Advent2023.Day06.Part1;

using Advent2023.Common;

/// <summary>
/// Represents the program to solve part 1 of day 6 of Advent of Code 2023.
/// </summary>
public class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        var result = sheet.WaysToWin().Aggregate((prev, next) => prev * next);
